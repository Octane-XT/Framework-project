...
public class FrontServlet extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException { 
    ...
    if (MappingUrls.containsKey(url)==true) {
      try {    
        ...
        ModelView mv = invokeMappedMethod(request,mapping,instance); 
  ...
  public ModelView invokeMappedMethod(HttpServletRequest request, Mapping mapping, Object clazz)throws Exception {
    ModelView r = null;
    Method methode = null;
    ...
    if (methode.getParameters().length > 0) {
      r = (ModelView) methode.invoke(clazz, extractParameters(request,methode));
    }else{
      r = (ModelView) methode.invoke(clazz);
    }
    return r;
  }
